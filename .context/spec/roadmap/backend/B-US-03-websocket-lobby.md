...
## Tareas (Tasks)
- [x] T1: Inicializar servidor Socket.IO en Fastify.
- [x] T2: Escuchar el evento de socket `join_lobby(nickname)`.
- [x] T3: Buscar si hay un lobby en status `waiting` (con 1 player). Si no, crear uno nuevo. Insertar o recuperar de base de datos.
- [x] T4: Al entrar un player, emitir evento `lobby_status` actual a todos en el lobby.
